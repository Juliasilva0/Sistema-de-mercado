...
public class Mercado {
    ...
    public void removerCategoria(int codigo){
        System.out.println(categorias.get(codigo).getNome()+ " Essa Categoria foi removida");
    ...
    public void apresentarCategorias(){
        for (int i=0; i<categorias.size();i++) {
            System.out.println("Codigo: "+1+", Nome da Categoria : " +categorias.get(i).getNome());
        }
    }
    ...
    public void apresentarCategoriaPorCodigo(int codigo){
        for (int i=0; i<categorias.size();i++) {
            ...
            }   //tem 3 verificaçoes(if, else if) pq so temos 3 categorias no mercado. 
        }
    }
